...
export default Navbar;
  ...
  // return (
  //   <div className="container d-flex justify-content-around m-3 border-bottom">
  ...
  //         <li>
  //           <NavLink to="/doctors" className="text-decoration-none text-black">
  //             ALL DOCTORS
  //           </NavLink>
  //         </li>
  ...
  //           </NavLink>
  //         </li>
  //         <button className="btn rounded-pill">Admin Pannel</button>
  //       </ul>
  //     </div>
  ...
  //           <img src={assets.dropdown_icon} className="dropdown" alt="" />

  //           <p onClick={() => navigate("/my-profile")}>My Profile</p>
  //           <p onClick={() => navigate("/my-appoinments")}>My Appointment</p>
